...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-05-2020 a las 19:25:33
...
CREATE TABLE `empleado` (
  ...
  `foto_empleado` longblob NOT NULL,
...
INSERT INTO `empleado` (`id_empleado`, `nom_empleado`, `usuario`, `password`, `correo`, `foto_empleado`, `edad_empleado`, `genero_empleado`, `id_sucursal`, `fecha_ingreso`, `fecha_salida`) VALUES
(704, 'Martina', 'Mart', '123456789', 'mart@cecep.edu.co', '', 22, 'f', 2, '2020-04-20 08:00:00', '2020-12-30 17:00:00'),
(977, 'Andres', 'Andre', '123456789', 'andre@cecep.edu.co', '', 25, 'm', 1, '2020-03-10 08:00:00', '2020-08-10 17:00:00');
...
(2, 'adm. sistema', 'tiene permitido el acceso al sistema para gestiones del mismo');
...
INSERT INTO `sucursal` (`id_sucursal`, `id_empresa`, `id_ciudad`) VALUES
(1, 1, 1),
(2, 1, 32);
...
--
ALTER TABLE `empleado`
  MODIFY `id_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=978;
...
--
ALTER TABLE `contratoxproceso`
  ADD CONSTRAINT `contratoxproceso_ibfk_1` FOREIGN KEY (`id_proceso`) REFERENCES `procesos` (`id_proceso`),
  ADD CONSTRAINT `contratoxproceso_ibfk_2` FOREIGN KEY (`id_contrato`) REFERENCES `contrato` (`id_contrato`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `contratoxproceso_ibfk_3` FOREIGN KEY (`id_empleado`) REFERENCES `empleado` (`id_empleado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `sucursal`
  ...
  ADD CONSTRAINT `sucursal_ibfk_2` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`);
